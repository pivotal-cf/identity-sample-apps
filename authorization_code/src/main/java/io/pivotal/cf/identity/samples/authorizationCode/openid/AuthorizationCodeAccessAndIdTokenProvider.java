package io.pivotal.cf.identity.samples.authorizationCode.openid;
...
public class AuthorizationCodeAccessAndIdTokenProvider extends AuthorizationCodeAccessTokenProvider {

    private StateKeyGenerator stateKeyGenerator = new DefaultStateKeyGenerator();
    private boolean stateMandatory = true;

    public AuthorizationCodeAccessAndIdTokenProvider() {
